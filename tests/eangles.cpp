...
void test_eangles()
{
	...
	TAssert(AngleVector(EAngle(0, 90, 0)) == Vector(0, 1, 0));
	TAssert(AngleVector(EAngle(0, -90, 0)) == Vector(0, -1, 0));
	TAssert(AngleVector(EAngle(90, 0, 0)) == Vector(0, 0, 1));
	TAssert(AngleVector(EAngle(-90, 0, 0)) == Vector(0, 0, -1));
	TAssert(AngleVector(EAngle(0, 0, 45)) == Vector(1, 0, 0));
	TAssert(AngleVector(EAngle(0, 0, -45)) == Vector(1, 0, 0));

	Vector vecForward, vecLeft, vecUp;
	AngleVectors(EAngle(0, 0, 0), &vecForward, &vecLeft, &vecUp);
	TAssert(vecForward == Vector(1, 0, 0));
	TAssert(vecLeft == Vector(0, 1, 0));
	TAssert(vecUp == Vector(0, 0, 1));
	AngleVectors(EAngle(0, 90, 0), &vecForward, &vecLeft, &vecUp);
	TAssert(vecForward == Vector(0, 1, 0));
	TAssert(vecLeft == Vector(-1, 0, 0));
	TAssert(vecUp == Vector(0, 0, 1));
	AngleVectors(EAngle(0, -90, 0), &vecForward, &vecLeft, &vecUp);
	TAssert(vecForward == Vector(0, -1, 0));
	TAssert(vecLeft == Vector(1, 0, 0));
	TAssert(vecUp == Vector(0, 0, 1));
	AngleVectors(EAngle(90, 0, 0), &vecForward, &vecLeft, &vecUp);
	...
	TAssert(vecLeft == Vector(0, 1, 0));
	TAssert(vecUp == Vector(1, 0, 0));
	AngleVectors(EAngle(0, 0, 45), &vecForward, &vecLeft, &vecUp);
	TAssert(vecForward == Vector(1, 0, 0));
	TAssert(vecLeft == Vector(0, 0.70710677f, -0.70710677f));
	...
	TAssert(VectorAngles(Vector(0, 1, 0)) == EAngle(0, 90, 0));
	TAssert(VectorAngles(Vector(0, -1, 0)) == EAngle(0, -90, 0));
	TAssert(VectorAngles(Vector(0, 0, 1)) == EAngle(90, 0, 0));
	TAssert(VectorAngles(Vector(0, 0, -1)) == EAngle(-90, 0, 0));
