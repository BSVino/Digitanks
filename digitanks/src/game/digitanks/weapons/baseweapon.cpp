...
static tchar* g_apszWeaponNames[WEAPON_MAX] =
{
	_T("None",
...
static tchar* g_apszWeaponDescriptions[WEAPON_MAX] =
{
	_T("None",
...
tchar* CBaseWeapon::GetWeaponName(weapon_t eProjectile)
{
	return g_apszWeaponNames[eProjectile];
}

tchar* CBaseWeapon::GetWeaponDescription(weapon_t eProjectile)
{
